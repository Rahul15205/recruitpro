...
const applicationSchema = z.object({
  resume: z
    ...
    .refine((files) => !files || files?.length === 0 || files?.[0]?.size <= 5000000, "File size must be less than 5MB"),
  answers: z.record(z.string().min(1, "This field is required")).optional()
})
              ...
              {status === 'loading' ? (
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500">
                    Applied {new Date(existingApplication.createdAt).toLocaleDateString()}
                  </p>
                </div>
