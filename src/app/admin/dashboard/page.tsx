...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Navbar />
      {/* Debug: Show session object */}
      <div className="max-w-7xl mx-auto px-4 py-2">
        <pre className="bg-yellow-50 border border-yellow-200 text-yellow-800 p-4 rounded mb-4 text-xs overflow-x-auto">
